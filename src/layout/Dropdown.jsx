    ...
    return (
        <div ref={dropDownEl}>
            <div 
                ...
                className={`flex px-2 py-2 rounded-lg hover:bg-gray-200 hover:bg-opacity-50 cursor-pointer ${isOpen ? 'text-white font-extrabold' : 'font-normal text-gray-200'}`}
                >
            ...
            {isOpen && (
                <div className="absolute grid grid-2 w-[28rem] h-full text-gray-200 top-0 left-64 rounded-r-3xl bg-prussianBlue border-r-[0.05rem] border-r-gray-600">
                    <div className="relative flex flex-col justify-evenly items-center border-b-[0.05rem] border-b-gray-600">
                        ...
                        <input type="text" placeholder="Search" className="w-96 h-10 p-2 rounded-lg bg-gray-300"/>
                    </div>
